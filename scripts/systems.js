...
export const SYSTEMS = {
    ...
    'dnd4e':                { actorTypes: ['Player Character'],      defaultItemType: 'xxx',                              handler: DnD4eSystem },
    'dnd5e':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: DnD5eSystem },
    'dungeonworld':         { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: DungeonworldSystem },
    'fate-core-official':   { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: FATESystem },
    'forbidden-lands':      { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: ForbiddenLandsSystem },
    'genesys':              { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: GenesysSystem },
    'hackmaster5e':         { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: Hackmaster5eSystem },
    'ose':                  { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: OSESystem },
    'pbta':                 { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: PbtASystem },
    'pf1':                  { actorTypes: ['character'],             defaultItemType: 'loot',      handler: PF1System },
    'pf2e':                 { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: PF2eSystem },
    'sfrpg':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: Starfinder1eSystem },
    'shadowdark':           { actorTypes: ['Player'],                defaultItemType: 'xxx',                              handler: ShadowdarkSystem },
    'shadowrun5e':          { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: Shadowrun5eSystem },
    'swade':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: SWADESystem },
    't2k4e':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: T2K4eSystem },
    'tor1e':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: TOR1eSystem },
    'tor2e':                { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: TOR2eSystem },
    'weirdwizard':          { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: SotWWSystem },
    'wfrp4e':               { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: WFRP4eSystem },
    'wwn':                  { actorTypes: ['character'],             defaultItemType: 'xxx',                              handler: WWNSystem },
};
